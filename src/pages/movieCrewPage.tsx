...
import PersonFilterUI, { nameFilter } from "../components/peopleFilterUI";
...
const MovieCrewPage: React.FC = () => {
  ...
  const { data, error, isLoading, isError } = useQuery<DiscoverCredits, Error>(
    ["movieCast", id],
    () => getCastOfMovie(id || "")
  );
  const {
  ...
  } = useQuery<ListedMovie, Error>(["movieCastDetails", id], () =>
    getMovie(id || "")
  );
